...
drbd:
  ...
  salt:
    ...
    promotion: "Fdrbdsles15-testnode-1"
  ...
  resource:
    - name: "beijing"
      ...
      virtual_ip: "192.168.30.201"

      nodes:
        - name: "Fdrbdsles15-testnode-1"
          ip: "192.168.30.100"
          port: 7990
          id: 1
        - name: "Fdrbdsles15-testnode-2"
          ip: "192.168.30.101"
          port: 7990
          id: 2
        - name: "Fdrbdsles15-testnode-3"
          ip: "192.168.30.102"
          port: 7990
          id: 3
